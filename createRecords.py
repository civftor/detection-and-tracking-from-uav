...
output_path = "/Volumes/Disque-Dur-S-C/aerial_tf_records/train.record";
num_shards = 8
max_size = 1024
...
def create_tf_example(example):
  ...
  if width > max_size or height > max_size or not os.path.splitext(filepath)[1] == ".png":
  ...
  for box in boxes:
    #class_no  xc yc w h
    xmins.append( box[1] - box[3]/2 )
    ymins.append( box[2] - box[4]/2 )
    xmaxs.append( box[1] + box[3]/2 )
    ymaxs.append( box[2] + box[4]/2 )
    _c = int(box[0]) + 1
    classes.append( _c )
